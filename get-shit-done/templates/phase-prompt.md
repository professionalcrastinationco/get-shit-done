...
<task type="auto">
  ...
  <verify>[Command or check to prove it worked. If user-visible UI changed, include a Playwright test.]</verify>
...
<task type="auto">
  ...
  <verify>[Command or check. If user-visible UI changed, include a Playwright test.]</verify>
...
- [ ] [Playwright tests for user-visible UI changes, if any]
</verification>
